    ...
    return (
        <header ref={ref}>
                                ...
                                <AnimatePresence>
                                    {servicesOpen && (
                                        <motion.div
                                            ...
                                            exit={{ opacity: 0, y: -10 }}
                                            className="absolute top-full left-0 mt-4 bg-white rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.12)] border border-gray-200 flex z-50 overflow-hidden"
                                            ...
                                            <div className="w-64 border-r">
                                                {servicesMenu.map((service, index) => (
                                                    <div
                                                        ...
                                                        className={`px-6 py-3 cursor-pointer transition ${activeService === index
            ...
            <motion.div
                ...
                className='fixed top-0 left-0 right-0 bg-white flex lg:hidden flex-col w-full mt-4 rounded-xl shadow-2xl z-50'
            >
                                                    ...
                                                    {servicesMenu.map((service, index) => (
                                                        <div key={service.title}>
                                                            ...
                                                            >
                                                                {service.title}
                                                                <span
                                                                    className={`transition-transform ${mobileActiveService === index ? "rotate-180" : ""
                                                                        }`}
                                                                >
                                                                    ▼
                                                                </span>
