...
function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Craft a unique brand identity and compelling visuals that resonate with your target audience.",
      link: "/brand-creative",
    ...
    },
    {
      ...
      description: "Amplify your brand's reach with strategic media planning and innovative advertising solutions.",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.a
              ...
              className="group block bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300"
            >
              {/* Image */}
