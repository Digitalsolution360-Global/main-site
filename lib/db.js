...
export async function getCityDetails(citySlug) {
  const sql = `
    SELECT c.*, 
           ...
           s.web_slug as state_web_slug, s.seo_slug as state_seo_slug, s.gmb_slug as state_gmb_slug,
           co.name as country_name, co.id as country_id,
           co.web_slug as country_web_slug, co.seo_slug as country_seo_slug, co.gmb_slug as country_gmb_slug
