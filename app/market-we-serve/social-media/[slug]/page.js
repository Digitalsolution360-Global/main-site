import SocialServicePageClient from './socialMarketClient'
...
export async function generateMetadata({ params }) {
  ...
  const title = `Best Social Media Marketing Company in ${locationName} | Digital Solution 360`
  const description = `Digital Solution 360 is a social media marketing company in ${locationName} offering content, paid ads & community management for UAE brands. Get a free audit.`
