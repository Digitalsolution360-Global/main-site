...
export const metadata = {
  ...
  description: 'See our Google My Business optimization portfolio. Real results from local businesses we helped with GMB management, local SEO, and online visibility.',
  keywords: 'GMB portfolio, Google My Business results, local SEO portfolio, GMB optimization case studies, local business marketing',
  openGraph: {
    title: 'Google My Business Portfolio - GMB Success Stories | Digital Solution 360',
    description: 'See our Google My Business optimization portfolio. Real results from local businesses we helped.',
