...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    // DB unavailable during build - return default metadata
    console.error('generateMetadata DB error:', error)
    return {
      title: 'Blog | Digital Solution 360',
      description: 'Read our latest blog posts on digital marketing, web development and SEO.',
      alternates: {
        canonical: `https://www.digitalsolution360.com/${slug}`,
      },
    }
